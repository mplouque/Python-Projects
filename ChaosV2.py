...
class ChaosGame(Canvas):
	...
	def play(self, n):
		...
		topVertex = Point(WIDTH/2 , VERTEX_RADIUS*2, "red")
		leftVertex = Point(VERTEX_RADIUS*2, HEIGHT- VERTEX_RADIUS*2, "green")
		rightVertex = Point(WIDTH - VERTEX_RADIUS*2 , HEIGHT- VERTEX_RADIUS*2, "blue")
		#creates a list containing each vertex
		vertexList = [topVertex, rightVertex, leftVertex]
		#midVertex = Point(WIDTH/2, HEIGHT * 2/3, "Black")
		#vertexList.append(midVertex)
		#plots each vertex as a red circle
		self.plotVertex(topVertex.xPoint, topVertex.yPoint, topVertex.color)
		self.plotVertex(leftVertex.xPoint, leftVertex.yPoint, leftVertex.color)
		self.plotVertex(rightVertex.xPoint, leftVertex.yPoint, rightVertex.color)
		...
		self.plot(startingMidpoint.xPoint, startingMidpoint.yPoint, startingMidpoint.color)
